locals {
  entity_event_lambda_name_old = "${local.environment}-entity-event-generator-lambda"
  entity_event_lambda_name     = "${local.environment}-dr2-entity-event-generator-lambda"
  entity_event_topic_name_old  = "${local.environment}-entity-event-generator-topic"
  entity_event_topic_name      = "${local.environment}-dr2-entity-event-generator-topic"
  entity_event_queue_name_old  = "${local.environment}-entity-event-queue"
...
module "entity_event_generator_lambda" {
  ...
  function_name = local.entity_event_lambda_name_old
...
module "entity_event_lambda_updated_since_query_start_datetime_table" {
  ...
  table_name = local.last_polled_table_name_old
}
...
module "entity_event_generator_queue" {
